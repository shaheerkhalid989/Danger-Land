    ...
    public partial class Level1 : Form
    {
        ...
        private void stopingCondition()
        {
            if(pHealth.Value == 0)
            {
                ...
                DieAction.Health = 100;
                DieAction.Score = 0;
                Restart newForm = new Restart();
                newForm.ShowDialog();
                this.Close();
            }

            else if (DieAction.Score >= 50)
            {
                GameLoop.Enabled = false;
                DieAction.Health = 100;
                DieAction.Score = 0;
        ...
        private void Level1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                game.playerFire(Properties.Resources.shot4_exp4, ObjectType.playerFire, new EightDirectional(20, "right"));
            }
        }
    }
}
